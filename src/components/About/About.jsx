    ...
    <section id="about" className="flex flex-col md:flex-row items-center justify-center p-6 md:p-12 bg-gray-100">
      ...
      <h2 className="text-4xl font-bold mb-12">About Us</h2>
        ...
        <p className="mt-4 text-gray-600">
          Welcome to <span className="font-semibold text-[#D32F2F]">Dawat E Zaika</span>, where every bite is a journey through rich flavors and traditions. We bring you the most authentic and delicious dishes, crafted with love and fresh ingredients.
        </p>
